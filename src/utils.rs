...
pub const SETTINGS_PATH: &str = "sd:/engage/DialogBoxToggle/";
...
static EN_US: phf::Map<&str, &str> = phf_map! {
    "button_on" => "Hide dialogue automatically in support conversations.",
    "button_off" => "Do not hide dialogue automatically in support conversations.",
    "talk_name" => "Hide support dialogue"
};
